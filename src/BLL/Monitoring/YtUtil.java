...
public class YtUtil {
	...
	public static boolean addToQueue(DASH_INFO info) {
		synchronized (lockObject) {
			...
			if (info.video) { //kt nếu là url video (hình ảnh)
				...
				videoQueue.add(info);
//				System.out.println("video added " + videoQueue.size());

				return true;
			} else {		 //ngược lại là audio (âm thanh)
				...
				audioQueue.add(info);
//				System.out.println("added added " + audioQueue.size());
				return true;
			}
		}
	}
